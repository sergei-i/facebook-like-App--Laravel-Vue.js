<template>
    <div class="bg-white rounded shadow w-2/3 mt-6 overflow-hidden">
        ...
        <div class="flex justify-between border-1 border-gray-400 m-4">
            <button
                class="flex justify-center py-2 rounded text-sm w-full focus:outline-none"
            ...
            <button
                class="flex justify-center py-2 rounded text-sm text-gray-600 w-full focus:outline-none"
